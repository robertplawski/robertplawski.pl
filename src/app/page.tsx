...
export default function Home() {
    return (
        <div
            className="relative font-sans  max-w-screen flex sm:justify-center items-center flex-col gap-8 min-h-screen p-8 gap-0 lg:p-20">
            <div className={"scale-90 sm:scale-100 xl:scale-130"}>
                <main
                    className="translate-y-6 grid grid-cols-1 border-neutral-700  lg:grid-cols-[1fr_auto] items-center gap-[32px] lg:gap-[48px] row-start-1 justify-center ">
                    ...
                    <div className={"flex flex-col h-full justify-around row-span-2 gap-2 text-xl"}>
                        ...
                        <ContactInfo icon={<MdEmail/>} label={"Robert's email address"}
                    ...
                    <div className={"flex flex-col gap-4"}>
                        <div
                            className={"grid grid-cols-5 md:grid-cols-9 text-4xl items-center  gap-2 justify-between "}>
                    ...
                    <div
                        ...
                        {CONFIG.experimental && <HeroButton variant="secondary" href={"#portfolio"}>
                            Portfolio
                        </HeroButton>}
                    ...
                    {!CONFIG.experimental && <footer
                        className={"text-md font-normal flex flex-row items-center  text-neutral-600 tracking-normal lg:tracking-widest "}>
                        <p>robertplawski.pl,
                            all
                            rights
                            reserved &copy;<CurrentYear/></p>
            ...
            {CONFIG.experimental && <div className={"flex flex-col gap-2 items-center absolute  bottom-10"}>
                <p>learn more</p>
                <FaChevronDown/>
            </div>}
        </div>
